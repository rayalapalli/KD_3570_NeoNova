...
| | |
|---|---|
| ![rqt graph](docs/figures/KD_3570_rqt_graph.png) *Live ROS 2 node/topic graph (`rqt_graph`) captured during Task 2A* | **[ADD_SOFTWARE_ENV_SCREENSHOT_HERE]** *e.g. a screenshot of Gazebo + RViz/rqt running side by side* |
